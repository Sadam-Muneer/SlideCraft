...
const Home = () => {
  ...
  return (
    <div className="bg-white min-h-screen flex items-center justify-center text-black py-10 sm:py-16">
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-7xl mx-auto p-4 md:p-8">
        <motion.div
          initial={{ opacity: 0, x: -100 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1.5, ease: "easeOut" }}
          className="flex-1 mb-4 md:mb-0 text-center md:text-left md:mr-8 gap-4" // Added md:mr-8 for gap
        >
